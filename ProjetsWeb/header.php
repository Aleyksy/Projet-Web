...
<nav> 
            ...
            <a <?php if(isset($_SESSION['Nom']))

            {
              ?>   

             href="accueil.php" <?php 
             }
              else
            {
                ?> href ="index.php" <?php 
             ...
             ?> 
             class="btn btn-primary btn-danger active"><span class="glyphicon glyphicon-home"></span> Accueil</a>
            ...
            if(isset($_SESSION['Nom']))
                {
                    ?>
                <div class="inscr">
                <a  href="panier.php" class="btn btn-danger active">Panier</a>
